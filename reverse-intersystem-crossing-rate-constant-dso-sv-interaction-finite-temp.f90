       ...
       REAL*8 :: TMIN, TMAX, HH, CM_AU, S_AU, T, SOC, AMU_AU, & 
                 ...
                 NUM2I, NUMR, NUMI, K_RISC_DSO1_REAL, ETA, &
                  THETA, T1, SCAL, DET_P2
       COMPLEX*16 :: DET, RISC_DSO, NUM, K_RISC_DSO1
...
!FINAL EXPRESSION OF REVERSE INTERSYSTEM CROSSING RATE FOR THE DSO PART
       ...
       WRITE (34, * ) T, REAL(RISC_DSO)  ! DO THE FFT ON THIS REAL(RISC_DSO) = G(T) i.e. TIME-DEPENDENT GENERATING FUNCTION TO GET THE RATE CONSTANT IN THE FREQUENCY DOMAIN.
